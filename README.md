...
### Submitting
- Commit your changes locally - use `git add` & `git commit`
...
- * Just to be sure, please also extract it locally in separate directory to be sure that changes are actually commited
